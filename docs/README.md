...
- `index.html` - Ana sayfa (tüm diller için linkler)
- `privacy-policy.html` - Gizlilik Politikası (Türkçe)
- `privacy-policy-en.html` - Privacy Policy (İngilizce)
- `privacy-policy-de.html` - Datenschutzerklärung (Almanca)
- `terms-of-service.html` - Kullanım Koşulları (Türkçe)
- `terms-of-service-en.html` - Terms of Service (İngilizce)
- `terms-of-service-de.html` - Nutzungsbedingungen (Almanca)
